...
<form class="searchForm" method="post" action="./admin/activities/actors">
            ...
            <div class="list-group-item">
                <div class="row">
                    ...
                    <div class="col-xs-10 col-md-11">
                        Sort by:
                        <a class="btn btn-link" data-sortable="visited">Last Visit</a>
                        <a class="btn btn-link" data-sortable="action_count">Action count</a>
                        <p class="help-block">Action counts are refreshed every 15 minutes.</p>
                    </div>
                </div>
            </div>        
                    ...
                    <div class="col-xs-11 col-sm-11 col-md-11">
                        <div class="row">
                            <div class="col-xs-12 col-sm-4 col-md-6">
                                <h5>
                                    <?php if ($item->isExcluded()) { echo "<span class='label label-danger'>excluded</span>&nbsp;"; } ?>
                                    <?php if ($item->isBot()) { echo "<span class='label label-warning'>bot</span>&nbsp;"; } ?>
                                    <?php /* ?><a href="./admin/activities/action/edit/<?php echo $item->id; ?>"> */ ?>
                                    <?php echo $item->name(); ?>
                                    <?php /* ?></a> */ ?>
                                </h5>
                                <?php if (!empty($item->ips)) { ?>
                                <ul>
                                    <?php foreach ($item->ips as $value) { ?>
                                        <li>
                                ...
                                <?php } ?>
                                <?php if (!empty($item->agents)) { ?>
                                <ul>
                                    <?php foreach ($item->agents as $value) { ?>
                                        <li>
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4">
                                <h5>
                                    <?php echo $item->actionCount(); ?> <small>actions</small>
                                </h5>
                            </div>
