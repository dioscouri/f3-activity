<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-table fa-fw "></i> Activity <span> > List </span>
        </h1>
    </div>
    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
        <ul id="sparks" class="list-actions list-unstyled list-inline">
            <li>
                <a class="btn btn-default" href="/admin/activity/create">Add New</a>
            </li>
        </ul>
    </div>
</div>
                    ...
                    <span class="pagination">
                        <div class="input-group">
                            <select id="bulk-actions" name="bulk_action" class="form-control">
                                ...
                                <option value="delete" data-action="/admin/activity/delete">Delete</option>
                            </select>
            ...
            <table class="table table-striped table-bordered table-hover table-highlight table-checkable">
                <thead>
                    <tr>
                        ...
                        <th data-sortable="Subject">Subject</th>
                        <th>Recipient(s)</th>
                        <th data-sortable="metadata.created.time">Created</th>
                        <th data-sortable="queue_status">Status</th>
                        <th>Scheduled</th>
                        <th>Sent</th>
                ...
                <?php if (!empty($paginated->items)) { ?>
                    ...
                    <tr>
                        ...
                        <td class="">
                            <a href="/admin/activity/edit/<?php echo $item->id; ?>">
                            <?php echo $item->Subject; ?>
                            </a>
                        </td>

                        <td class="">
                            <?php echo implode(", ", (array) $item->all_recipients ); ?>
                        </td>
                        ...
                        <td class="">
                            ...
                            ?>
                            <div class="alert <?php echo $alert_class; ?>"><?php echo $item->queue_status; ?></div>
                        </td>
                        ...
                        <td class="text-center"><a class="btn btn-xs btn-secondary" href="/admin/activity/email/edit/<?php echo $item->id; ?>">
                                <i class="fa fa-pencil"></i>
                            </a> &nbsp; <a class="btn btn-xs btn-danger" data-bootbox="confirm" href="/admin/activity/email/delete/<?php echo $item->id; ?>">
